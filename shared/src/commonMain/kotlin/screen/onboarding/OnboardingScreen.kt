...
fun OnboardingScreen(
    ...
    val viewModel = koinViewModel(OnboardingViewModel::class)
    val isOnboardingCompleted by viewModel.isOnboardingCompleted.collectAsStateWithLifecycle(initial = null)
    LaunchedEffect(isOnboardingCompleted) {
        if (isOnboardingCompleted == true) onOnboardingCompleted()
    }
    AnimatedContent(
